...
# -*- coding: utf-8 -*-
#
# pytest_ngsfixtures documentation build configuration file, created by
...
from pytest_ngsfixtures import __version__
...
htmlhelp_basename = 'pytest_ngsfixturesdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'pytest_ngsfixtures.tex',
     u'pytest-ngsfixtures Documentation',
